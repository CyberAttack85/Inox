...
#DEC-FUCK-YOUR-MOM-DON'T-BYPASS-MY-COMMAND( LUND LE MAMA BYPASS HOGAI 🤣)
...
def back():
    login()
def contact():
    os.system('xdg-open https://www.facebook.com/groups/204259606025735/?ref=share_group_link')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
def crack_file():
	os.system('clear')
	banner()
	os.system('espeak -a 300 " puth, your, file"')
	print('\033[1;32m [Put File Example:  /sdcard/mama.txt  Etc...]')
	o = input('\x1b[1;97m [+] File Path : ')
	print('')
...
def setting():
	...
	if hu in ['1','01']:
		...
		for bacot in id:
			xx = random.randint(0,len(id2))
			id2.insert(xx,bacot)
	print('\x1b[1;92m ACTIVE FILE\n\x1b[1;97m [1] METHOD Coke.. ')
	os.system('espeak -a 300 " You selected Method 1, New Method, Coming, Soon"')
	hc = input(' CHOOSE: ')
	if hc in ['1','01']:
