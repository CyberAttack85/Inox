...
CorrectUsername = 'YAMIN'
CorrectPassword = 'JANNATI'
key = 'true'
while key == 'true':
	password  = 'true'
while password  == 'true':	
    ...
    if username == CorrectUsername:
            print(f'\033[1;37m-----------------------------------------------\n\033[0;97m[•]\033[1;32m LOGGED IN YAMIN TOOL SUCCESSFULLY') 
            Password = input('\033[0;97m[•]\033[1;96m•────➤\033[1;92mENTER KEY \033[1;91m: \x1b[1;92m')
