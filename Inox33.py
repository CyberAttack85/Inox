...
os.system('clear')
psb('\x1b[1;32mTHIS TOOL WAS MADE BY KHALID SHAIFULLAH IF YOU WANT TO TAKE ITS CREDIT,LOOK AT YOURSELF AGAIN. FOR ANY HELP JOIN OUR FACEBOOK GROUP AND POST. BANGLADESH 11 DIGIT CLONING STARTING.................')
for n in range(9999):
...
os.system('xdg-open https://youtube.com/channel/UC0egLGX2MkV-yqqC4ej4JYg')
...
def menu():
    ...
    print logo
    print ''
    print 'AUTHOR: Khalid Shaifullah'
    print 'FACEBOOK : khalid.shaifullah.official'
    print 'GITHUB : Khalid2009sm'
