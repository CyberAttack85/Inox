#!/usr/bin/python3
# Open source Kayli Kankir pola Kalid 😅
#Open Source Asraful Islam Hasan
#Github : KgHasan
import os
try:
    import requests
...
def sarfraz():
    ...
    IP = ipm['origin']
    print
    print('\033[0;92m [1] START FILE CRACKING')
    print(' [2] CREATE FILE')
    print(' [3] EXIT ')
    print('')
...
class __xxx__:
    ...
    def __pler__(self):
        ...
        print('[2] CRACK WITH NAME AND DIGIT PASS')
        chi = input('\n [?] CHOOSE: ')
        if chi == '':
            print('\nSELECT CORRECT ONE')
            self.__pler__()
            ...
            os.system("clear")
            print(logo)
            print("\033[1;31m \rCONNECT A VPN FOR FAST CLONING\033[1;37m")
            print(47*"-")
